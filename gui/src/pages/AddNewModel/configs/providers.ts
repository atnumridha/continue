...
export const providers: Partial<Record<string, ProviderInfo>> = {
  cometapi: {
    ...
    longDescription:
      "Unified Access to Leading AI Models, see [here](https://www.cometapi.com/?utm_source=qivryn&utm_medium=integration&utm_campaign=cometapi_integration&utm_content=qivryn_plugin) for more details.",
    icon: "cometapi.png",
  ...
  moonshot: {
    ...
    longDescription: `[Visit our documentation](https://docs.qivryn.ai/reference/Model%20Providers/moonshot) for information on obtaining an API key.`,
    icon: "moonshot.png",
    tags: [ModelProviderTags.RequiresApiKey],
    refPage: "moonshot",
  ...
  azure: {
    ...
    longDescription: `[Visit our documentation](https://docs.qivryn.ai/reference/Model%20Providers/azure) for information on obtaining an API key.
...
Select the \`GPT-4o\` model below to complete your provider configuration, but note that this will not affect the specific model you need to select when creating your Azure deployment.`,
  ...
  novita: {
    ...
    icon: "novita.png",
    longDescription: `[Novita AI](https://novita.ai?utm_source=github_qivryn&utm_medium=github_readme&utm_campaign=github_link) offers an affordable, reliable, and simple inference platform with scalable [LLM APIs](https://novita.ai/docs/model-api/reference/introduction.html), empowering developers to build AI applications. To get started with Novita AI:\n1. Obtain an API key from [here](https://novita.ai/settings/key-management?utm_source=github_qivryn&utm_medium=github_readme&utm_campaign=github_link)\n2. Paste below\n3. Select a model preset`,
    tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
    params: {
      apiKey: "",
    },
    ...
    apiKeyUrl:
      "https://novita.ai/settings/key-management?utm_source=github_qivryn&utm_medium=github_readme&utm_campaign=github_link",
  },
  gemini: {
    title: "Google Gemini",
    provider: "gemini",
  ...
  lemonade: {
    ...
    longDescription:
      "Lemonade provides optimized local LLM inference with support for AMD NPU, GPU, and CPU acceleration. Visit [lemonade-server.ai](https://lemonade-server.ai/) for installation and setup instructions. Once the Lemonade server is running, you can begin using Qivryn with your local models.",
    icon: "lemonade.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    params: {
...
After it's up and running, you can start using Qivryn.`,
    icon: "llamacpp.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    packages: openSourceModels,
    collectInputFor: [...completionParamsInputsConfigs],
...
- [llama-cpp-python](https://github.com/atnumridha/ggml-server-example)
...
To get started, [register](https://dataplatform.cloud.ibm.com/registration/stepone?context=wx) on watsonx SaaS, create your first project and setup an [API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key).`,
  ...
  sambanova: {
    ...
    icon: "sambanova.png",
    longDescription: `The SambaNova Cloud is a cloud platform for running large open source AI models with the world record performance and zero data retention. You can sign up [here](http://cloud.sambanova.ai?utm_source=qivryn&utm_medium=external&utm_campaign=cloud_signup)`,
    tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
    params: {
      apiKey: "",
    },
